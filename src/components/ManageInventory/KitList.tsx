...
const KitList: React.FC<InventoryListTableProps> = ({ fetchAllKitDetails}) => {
  ...
  const iconColor = currentTheme === "light" ? "lightgrey" : ""; // Change as needed
  const deleteIconColor = currentTheme === "light" ? "red" : ""; // Change as needed
  const columns: Column[] = [
    { key: "barcode_number", label: "Barcode", sortable: true },
          ...
          <div>
            ...
            <div className="d-flex justify-content-between w-100 btn_wrap">
              ...
              <div className="btn_grp">
                ...
                >
                  <FontAwesomeIcon icon={faKey} /> Cancel
                </Button>
              </div>
            </div>
          </div>
        ...
        <div className="table_top">
          <div className="search_outer">
            ...
            <div className="info-icon">
              <Tooltip
                title={`Search by barcode, type, status, created on`}
              >
                <FontAwesomeIcon
                  icon={faInfoCircle}
